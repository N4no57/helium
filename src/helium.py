    ...
    def make_tokens(self):
        ...
        while self.current_char is not None:
            if self.current_char in ' \t':
                ...
                tokens.append(self.make_string_SQ())
            elif self.current_char == '+':
                ...
                tokens.append(Token(TT_LCB, pos_start=self.pos))
                self.advance()
            elif self.current_char == '}':
                tokens.append(Token(TT_RCB, pos_start=self.pos))
                self.advance()
            elif self.current_char == '!':
...
class ParseResult:
    def __init__(self):
        self.error = None
        self.node = None
        self.last_registered_advanced_count = 0
        self.advance_count = 0
        self.to_reverse_count = 0

    def register_advancement(self):
        self.last_registered_advanced_count = 1
        self.advance_count += 1

    def register(self, res):
        self.last_registered_advanced_count = res.advance_count
    ...
    def if_expr_c(self):
        ...
        if self.current_tok.matches(TT_KEYWORD, 'else'):
            ...
            if self.current_tok.type == TT_NEWLINE:
                ...
                if self.current_tok.type == TT_RCB:
                    res.register_advancement()
                    self.advance()
                else:
                    return res.failure(InvalidSyntaxError(
...
class BuiltInFunction(BaseFunction):
    ...
    execute_delete.arg_names = ['list', 'value']
...
BuiltInFunction.delete = BuiltInFunction("delete")
...
global_symbol_table.set("delete", BuiltInFunction.delete)
